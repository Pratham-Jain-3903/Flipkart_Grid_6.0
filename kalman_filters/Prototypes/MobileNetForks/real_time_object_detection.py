...
CLASSES = ["toy_plane", "background", "health & fitness", "toy_bird", "toy_boat",
           "FMCG_bottled_products", "toy_bus", "automobile_car", "toy_plushie", "household_items_chair", "toy_softtoy", "household_items_diningtable",
           "toy_dog", "toy_horse", "automobile_bike", "person", "household_items_pottedplant", "toy_sheep",
           "household_items_sofa", "toy_train", "electromics_tv"]
...
while True:
    ...
    for i in np.arange(0, predictions.shape[2]):
        ...
        if confidence > CONFIDENCE:
            ...
            print("Index:", idx," ","Number of classes:", len(CLASSES))
